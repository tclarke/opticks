      ...
      for(stage = 0; sstr.good() && stage != 2; )
      {
         ...
         if(stage == 1)
         {
            ...
            else
            {
               ...
               lineStr >> aerosol.mHeight
                       >> aerosol.mPressure
                       >> aerosol.mTemperature
                       >> aerosol.mWaterVaporDensity
                       >> aerosol.mAlternateTemperature
                       >> aerosol.mAlternateWaterVaporDensity;
               long location;
               lineStr >> location;
      ...
      for(stage = 0; sstr.good() && stage != 2; )
      {
         ...
         if(stage == 1)
         {
            ...
            else
            {
               ...
               {
                  wx.mCloudBase1 =  wx.mCloudCoverage1 = wx.mCloudThickness1 = 0;
               }
               ...
               {
                  wx.mCloudBase2 =  wx.mCloudCoverage2 = wx.mCloudThickness2 = 0;
               }
               ...
               {
                  wx.mCloudBase3 =  wx.mCloudCoverage3 = wx.mCloudThickness3 = 0;
               }
               ...
               {
                  wx.mCloudBase4 =  wx.mCloudCoverage4 = wx.mCloudThickness4 = 0;
               }
...
bool AspamImporter::deserialize(FILE* pFp)
{
   ...
   { // scope the resource
      ...
      while(!feof(pFp))
      {
         ...
         unsigned int numberRead = fread(buf, sizeof(char), 1023, pFp);
         buf[numberRead] = NULL;
         data += (char*)buf;
      }
