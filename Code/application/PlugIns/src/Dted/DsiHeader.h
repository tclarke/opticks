...
class DsiHeader
{
   ...
   float mLatOrigin, mLongOrigin;
   float mSWLatCorner, mSWLongCorner; 
   float mNWLatCorner, mNWLongCorner; 
   float mNELatCorner, mNELongCorner; 
   float mSELatCorner, mSELongCorner;
   float mClockwiseOrientation;
   float mLatInterval, mLongInterval;
